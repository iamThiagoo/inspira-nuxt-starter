<template>
    <svg fill="none" xmlns="http://www.w3.org/2000/svg" :width="width" :height="height"
        ...
        <path
            ...
            class="fill-white dark:fill-[#262626]"></path>
        ...
        <image v-if="src" x="21.25" y="19.25" width="389.5" height="843.5" preserveAspectRatio="xMidYMid slice"
            style="clip-path: url(#roundedCorners)" :href="src"></image>

        <path
            d="M154 48.5C154 38.2827 162.283 30 172.5 30H259.5C269.717 30 278 38.2827 278 48.5C278 58.7173 269.717 67 259.5 67H172.5C162.283 67 154 58.7173 154 48.5Z"
            class="fill-[#F5F5F5] dark:fill-[#262626]"></path>
        <path
